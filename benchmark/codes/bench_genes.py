...
parser.add_argument('--netP', type=float, default=0.25, help='Current network density')
parser.add_argument('--round', type=int, help='Current round')
parser.add_argument('--train_size', type=float, default=0.75, help='Fraction of training samples.')
parser.add_argument('--filen', type=str, default="/home/jiawen/myMLnet/benchmark/Beeline/outputs/results_genes.csv", help='The filename')
...
# result = [cur_round, len(gene_all),AUC_final,AUPR_final]
result = [cur_round, args.train_size, AUC_final,AUPR_final]
filen = args.filen

with open(filen, 'a', newline='') as file:
