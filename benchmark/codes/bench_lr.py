...
print(' - Round:{:.3F}'.format(args.round),', learning rate: {:.5F}'.format(args.lr),' batch size: {:.1F}'.format(args.batch_size),' - \n')
...
result = [cur_round, args.lr, args.batch_size,AUC_final,AUPR_final]
filen = "/home/jiawen/myMLnet/benchmark/Beeline/outputs/results_lr.csv"
